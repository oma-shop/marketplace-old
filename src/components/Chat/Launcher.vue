...
export default {
  ...
  mounted() {
    console.log("chat - mounted", this.colors)
    console.log("chat - scopedProps", this.scopedProps)
  },
  created() {
    console.log("chat -created scopedProps", this.scopedProps)
    console.log("chat -created scopedProps", this.user)
    console.log("chat -created scopedProps", this.message)
  },
  components: {
    ChatWindow
  }
