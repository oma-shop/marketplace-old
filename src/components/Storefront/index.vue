<template>
  <div class="storefront">
    ...
    <center><h1><font color=#409EFF> Online Marketplace Application Demo</font></h1></center>
    ...
    <!--<router-link to="/products">Discover Products!</router-link>-->
     &nbsp;&nbsp; 
    <h2><center><font color=#FFFFFF>
     &nbsp;&nbsp; 
      You are connected to store:</font>
      <strong v-if=" $store.state.shop.shop.data">{{ $store.state.shop.shop.data.name }}</strong>
    </center></h2>
    <h3><center><font color=#FFFFFF>Connect to another shop?</font></center></h3>
